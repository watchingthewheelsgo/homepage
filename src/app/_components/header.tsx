...
const Header = () => {
  return (
    <header className='w-full p-4 px-10 items-center justify-between flex'>
        ...
        fixed right-1/2 translate-x-1/2 text-dark bg-light/80 backdrop-blur-sm z-50'>
            <Link href='/' className='mr-2'>Home</Link>
            <Link href='/categories/all' className='mx-2'>Blog</Link>
            <Link href='/life' className='mx-2'>Life</Link>
            <Link href='/writer' className='mx-2'>Writer</Link>
